...
\usepackage{xcolor}
\definecolor{dsblue}{RGB}{50,90,160}
\definecolor{dslight}{RGB}{220,235,255}
\definecolor{dsaccent}{RGB}{255,140,0}

\setbeamercolor{block title}{fg=white,bg=dsblue}
\setbeamercolor{block body}{fg=black,bg=dslight}
\setbeamercolor{title}{fg=dsaccent}
